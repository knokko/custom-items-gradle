...
import nl.knokko.customitems.item.MultiBlockBreak;
...
public class EditMultiBlockBreak extends GuiMenu {
    ...
    private final Consumer<MultiBlockBreak> changeValues;
    private final GuiComponent returnMenu;

    private final MultiBlockBreak currentValues;

    public EditMultiBlockBreak(
            MultiBlockBreak oldValues, Consumer<MultiBlockBreak> changeValues, GuiComponent returnMenu
    ) {
    ...
    private GuiTexture getShapeTexture(MultiBlockBreak.Shape shape) {
    ...
    protected void addComponents() {
        ...
        addComponent(
                createShapeButton(MultiBlockBreak.Shape.CUBE, shapeImageWrapper),
                0.45f, 0.8f, 0.55f, 0.9f
        );
        addComponent(
                createShapeButton(MultiBlockBreak.Shape.MANHATTAN, shapeImageWrapper),
    ...
    private ActivatableTextButton createShapeButton(
            MultiBlockBreak.Shape shape, WrapperComponent<SimpleImageComponent> shapeImageWrapper
    ) {
