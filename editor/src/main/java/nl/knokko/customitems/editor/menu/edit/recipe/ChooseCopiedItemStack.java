...
public abstract class ChooseCopiedItemStack extends GuiMenu {

	private final GuiComponent cancelMenu;

	private final DynamicTextComponent errorComponent;

	public ChooseCopiedItemStack(GuiComponent cancelMenu) {
		this.cancelMenu = cancelMenu;
		this.errorComponent = new DynamicTextComponent("", EditProps.ERROR);
	}

	protected abstract void onPaste(String content);
