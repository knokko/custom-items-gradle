...
public class EditPotionAura extends EditProjectileEffect<PEPotionAura> {

    public EditPotionAura(
            PEPotionAura oldValues, Consumer<ProjectileEffect> applyChanges, GuiComponent returnMenu
    ) {
