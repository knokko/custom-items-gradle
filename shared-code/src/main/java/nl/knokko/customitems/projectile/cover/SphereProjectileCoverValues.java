...
public class SphereProjectileCoverValues extends ProjectileCoverValues {
    ...
    public SphereProjectileCoverValues(boolean mutable) {
        super(mutable);
        this.texture = null;
    ...
    public SphereProjectileCoverValues(SphereProjectileCoverValues toCopy, boolean mutable) {
    ...
    @Override
    public SphereProjectileCoverValues copy(boolean mutable) {
        return new SphereProjectileCoverValues(this, mutable);
    }
