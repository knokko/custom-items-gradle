...
public class ShowFireworkValues extends ProjectileEffectValues {
    ...
    static ShowFireworkValues load(BitInput input, byte encoding) throws UnknownEncodingException {
        ShowFireworkValues result = new ShowFireworkValues(false);
    ...
    public ShowFireworkValues(ShowFireworkValues toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public ShowFireworkValues copy(boolean mutable) {
