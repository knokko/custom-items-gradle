...
public class PEColoredRedstone extends ProjectileEffect {

    static PEColoredRedstone load(BitInput input, byte encoding) throws UnknownEncodingException {
        PEColoredRedstone result = new PEColoredRedstone(false);
    ...
    public PEColoredRedstone(boolean mutable) {
        super(mutable);
        this.minRed = 200;
        this.minGreen = 0;
        this.minBlue = 0;
    ...
    public PEColoredRedstone(PEColoredRedstone toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public PEColoredRedstone copy(boolean mutable) {
        return new PEColoredRedstone(this, mutable);
    }

    @Override
    public boolean equals(Object other) {
        if (other.getClass() == PEColoredRedstone.class) {
            PEColoredRedstone otherEffect = (PEColoredRedstone) other;
