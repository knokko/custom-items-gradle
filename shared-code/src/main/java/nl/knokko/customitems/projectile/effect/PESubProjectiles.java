...
public class PESubProjectiles extends ProjectileEffect {

    static PESubProjectiles load(BitInput input, byte encoding, ItemSet itemSet) throws UnknownEncodingException {
        PESubProjectiles result = new PESubProjectiles(false);
    ...
    public PESubProjectiles(boolean mutable) {
        super(mutable);
        this.child = null;
    ...
    public PESubProjectiles(PESubProjectiles toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public PESubProjectiles copy(boolean mutable) {
        return new PESubProjectiles(this, mutable);
    }

    @Override
    public boolean equals(Object other) {
        if (other.getClass() == PESubProjectiles.class) {
            PESubProjectiles otherEffect = (PESubProjectiles) other;
