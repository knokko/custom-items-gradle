...
public enum VBiome {
    ...
    frozen_ocean(VERSION26, VERSION26),
    savanna_plateau(VERSION26, VERSION26),
    taiga(VERSION26, VERSION26),
    savanna(VERSION26, VERSION26),
    dripstone_caves(VERSION26, VERSION26),
    swamp(VERSION26, VERSION26),
    basalt_deltas(VERSION26, VERSION26),
    ice_spikes(VERSION26, VERSION26),
    cherry_grove(VERSION26, VERSION26),
    crimson_forest(VERSION26, VERSION26),
    frozen_peaks(VERSION26, VERSION26),
    dark_forest(VERSION26, VERSION26),
    lush_caves(VERSION26, VERSION26),
    old_growth_spruce_taiga(VERSION26, VERSION26),
    deep_dark(VERSION26, VERSION26),
    frozen_river(VERSION26, VERSION26),
    lukewarm_ocean(VERSION26, VERSION26),
    mushroom_fields(VERSION26, VERSION26),
    warm_ocean(VERSION26, VERSION26),
    forest(VERSION26, VERSION26),
    end_midlands(VERSION26, VERSION26),
    windswept_forest(VERSION26, VERSION26),
    deep_ocean(VERSION26, VERSION26),
    sunflower_plains(VERSION26, VERSION26),
    stony_peaks(VERSION26, VERSION26),
    stony_shore(VERSION26, VERSION26),
    nether_wastes(VERSION26, VERSION26),
    deep_lukewarm_ocean(VERSION26, VERSION26),
    flower_forest(VERSION26, VERSION26),
    old_growth_birch_forest(VERSION26, VERSION26),
    desert(VERSION26, VERSION26),
    snowy_taiga(VERSION26, VERSION26),
    beach(VERSION26, VERSION26),
    grove(VERSION26, VERSION26),
    deep_frozen_ocean(VERSION26, VERSION26),
    river(VERSION26, VERSION26),
    old_growth_pine_taiga(VERSION26, VERSION26),
    the_void(VERSION26, VERSION26),
    deep_cold_ocean(VERSION26, VERSION26),
    windswept_gravelly_hills(VERSION26, VERSION26),
    snowy_plains(VERSION26, VERSION26),
    end_highlands(VERSION26, VERSION26),
    jagged_peaks(VERSION26, VERSION26),
    eroded_badlands(VERSION26, VERSION26),
    bamboo_jungle(VERSION26, VERSION26),
    end_barrens(VERSION26, VERSION26),
    plains(VERSION26, VERSION26),
    small_end_islands(VERSION26, VERSION26),
    meadow(VERSION26, VERSION26),
    the_end(VERSION26, VERSION26),
    snowy_beach(VERSION26, VERSION26),
    sparse_jungle(VERSION26, VERSION26),
    jungle(VERSION26, VERSION26),
    snowy_slopes(VERSION26, VERSION26),
    birch_forest(VERSION26, VERSION26),
    mangrove_swamp(VERSION26, VERSION26),
    ocean(VERSION26, VERSION26),
    cold_ocean(VERSION26, VERSION26),
    soul_sand_valley(VERSION26, VERSION26),
    warped_forest(VERSION26, VERSION26),
    badlands(VERSION26, VERSION26),
    pale_garden(VERSION26, VERSION26),
    windswept_hills(VERSION26, VERSION26),
    windswept_savanna(VERSION26, VERSION26),
    wooded_badlands(VERSION26, VERSION26);
