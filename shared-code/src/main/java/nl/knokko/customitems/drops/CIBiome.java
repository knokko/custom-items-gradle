...
public enum CIBiome {
    OCEAN(VERSION1_12, VERSION1_19),
    PLAINS(VERSION1_12, VERSION1_19),
    DESERT(VERSION1_12, VERSION1_19),
    EXTREME_HILLS(VERSION1_12, VERSION1_12),
    FOREST(VERSION1_12, VERSION1_19),
    TAIGA(VERSION1_12, VERSION1_19),
    SWAMPLAND(VERSION1_12, VERSION1_12),
    RIVER(VERSION1_12, VERSION1_19),
    HELL(VERSION1_12, VERSION1_12),
    SKY(VERSION1_12, VERSION1_12),
    FROZEN_OCEAN(VERSION1_12, VERSION1_19),
    FROZEN_RIVER(VERSION1_12, VERSION1_19),
    ...
    DEEP_OCEAN(VERSION1_12, VERSION1_19),
    STONE_BEACH(VERSION1_12, VERSION1_12),
    COLD_BEACH(VERSION1_12, VERSION1_12),
    BIRCH_FOREST(VERSION1_12, VERSION1_19),
    ...
    SAVANNA(VERSION1_12, VERSION1_19),
    ...
    SAVANNA_PLATEAU(VERSION1_13, VERSION1_19),
    BADLANDS(VERSION1_13, VERSION1_19),
    WOODED_BADLANDS_PLATEAU(VERSION1_13, VERSION1_17),
    BADLANDS_PLATEAU(VERSION1_13, VERSION1_17),
    SMALL_END_ISLANDS(VERSION1_13, VERSION1_19),
    END_MIDLANDS(VERSION1_13, VERSION1_19),
    END_HIGHLANDS(VERSION1_13, VERSION1_19),
    END_BARRENS(VERSION1_13, VERSION1_19),
    WARM_OCEAN(VERSION1_13, VERSION1_19),
    LUKEWARM_OCEAN(VERSION1_13, VERSION1_19),
    COLD_OCEAN(VERSION1_13, VERSION1_19),
    DEEP_WARM_OCEAN(VERSION1_13, VERSION1_17),
    DEEP_LUKEWARM_OCEAN(VERSION1_13, VERSION1_19),
    DEEP_COLD_OCEAN(VERSION1_13, VERSION1_19),
    DEEP_FROZEN_OCEAN(VERSION1_13, VERSION1_19),
    THE_VOID(VERSION1_13, VERSION1_19),
    SUNFLOWER_PLAINS(VERSION1_13, VERSION1_19),
    DESERT_LAKES(VERSION1_13, VERSION1_17),
    GRAVELLY_MOUNTAINS(VERSION1_13, VERSION1_17),
    FLOWER_FOREST(VERSION1_13, VERSION1_19),
    TAIGA_MOUNTAINS(VERSION1_13, VERSION1_17),
    SWAMP_HILLS(VERSION1_13, VERSION1_17),
    ICE_SPIKES(VERSION1_13, VERSION1_19),
    ...
    ERODED_BADLANDS(VERSION1_13, VERSION1_19),
    MODIFIED_WOODED_BADLANDS_PLATEAU(VERSION1_13, VERSION1_17),
    MODIFIED_BADLANDS_PLATEAU(VERSION1_13, VERSION1_17),
    BAMBOO_JUNGLE(VERSION1_14, VERSION1_19),
    BAMBOO_JUNGLE_HILLS(VERSION1_14, VERSION1_17),
    NETHER_WASTES(VERSION1_16, VERSION1_19),
    SOUL_SAND_VALLEY(VERSION1_16, VERSION1_19),
    CRIMSON_FOREST(VERSION1_16, VERSION1_19),
    WARPED_FOREST(VERSION1_16, VERSION1_19),
    BASALT_DELTAS(VERSION1_16, VERSION1_19),
    CUSTOM(VERSION1_16, VERSION1_19),
    DRIPSTONE_CAVES(VERSION1_17, VERSION1_19),
    LUSH_CAVES(VERSION1_17, VERSION1_19),
    WINDSWEPT_HILLS(VERSION1_18, VERSION1_19),
    SNOWY_PLAINS(VERSION1_18, VERSION1_19),
    SPARSE_JUNGLE(VERSION1_18, VERSION1_19),
    STONY_SHORE(VERSION1_18, VERSION1_19),
    OLD_GROWTH_PINE_TAIGA(VERSION1_18, VERSION1_19),
    WINDSWEPT_FOREST(VERSION1_18, VERSION1_19),
    WOODED_BADLANDS(VERSION1_18, VERSION1_19),
    WINDSWEPT_GRAVELLY_HILLS(VERSION1_18, VERSION1_19),
    OLD_GROWTH_BIRCH_FOREST(VERSION1_18, VERSION1_19),
    OLD_GROWTH_SPRUCE_TAIGA(VERSION1_18, VERSION1_19),
    WINDSWEPT_SAVANNA(VERSION1_18, VERSION1_19),
    MEADOW(VERSION1_18, VERSION1_19),
    GROVE(VERSION1_18, VERSION1_19),
    SNOWY_SLOPES(VERSION1_18, VERSION1_19),
    FROZEN_PEAKS(VERSION1_18, VERSION1_19),
    JAGGED_PEAKS(VERSION1_18, VERSION1_19),
    STONY_PEAKS(VERSION1_18, VERSION1_19),
    MANGROVE_SWAMP(VERSION1_19, VERSION1_19),
    DEEP_DARK(VERSION1_19, VERSION1_19);
