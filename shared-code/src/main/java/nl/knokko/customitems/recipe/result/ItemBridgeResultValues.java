...
public class ItemBridgeResultValues extends ResultValues {
    ...
    public static ItemBridgeResultValues load(BitInput input) throws UnknownEncodingException {
        ...
        ItemBridgeResultValues result = new ItemBridgeResultValues(false);
    ...
    public ItemBridgeResultValues(boolean mutable) {
        super(mutable);
        this.itemId = "minecraft:dirt";
        this.amount = 3;
    }

    public ItemBridgeResultValues(ItemBridgeResultValues toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public ItemBridgeResultValues copy(boolean mutable) {
        return new ItemBridgeResultValues(this, mutable);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof ItemBridgeResultValues) {
            ItemBridgeResultValues otherResult = (ItemBridgeResultValues) other;
