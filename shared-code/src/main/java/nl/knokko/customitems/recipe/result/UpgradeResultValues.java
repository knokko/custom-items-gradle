...
public class UpgradeResultValues extends ResultValues {
    ...
    public static UpgradeResultValues load(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
    ...
    public UpgradeResultValues(boolean mutable) {
        super(mutable);
    ...
    public UpgradeResultValues(UpgradeResultValues toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public UpgradeResultValues copy(boolean mutable) {
        return new UpgradeResultValues(this, mutable);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof UpgradeResultValues) {
            UpgradeResultValues otherUpgrade = (UpgradeResultValues) other;
    ...
    public void setNewType(ResultValues newType) {
        assertMutable();
    ...
    public void validateIndependent() throws ValidationException, ProgrammingValidationException {
        ...
        if (newType != null) {
            if (newType instanceof UpgradeResultValues) {
