...
public class KciWand extends KciItem {

    public static KciWand load(
            BitInput input, byte encoding, ItemSet itemSet
    ) throws UnknownEncodingException {
        KciWand result = new KciWand(false);
    ...
    public KciWand(boolean mutable) {
    ...
    public KciWand(KciWand toCopy, boolean mutable) {
    ...
    protected void loadWandPropertiesNew(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
        ...
        if (input.readBoolean()) {
            this.charges = WandCharges.load1(input);
        } else {
            this.charges = null;
        }
    ...
    public boolean equals(Object other) {
        return other.getClass() == KciWand.class && areWandPropertiesEqual((KciWand) other);
    }

    @Override
    public KciWand copy(boolean mutable) {
        return new KciWand(this, mutable);
    }
    ...
    public void setCharges(WandCharges newCharges) {
        assertMutable();
