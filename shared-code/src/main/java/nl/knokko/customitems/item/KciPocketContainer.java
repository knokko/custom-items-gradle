...
public class KciPocketContainer extends KciItem {

    static KciPocketContainer load(
            BitInput input, byte encoding, ItemSet itemSet
    ) throws UnknownEncodingException {
        KciPocketContainer result = new KciPocketContainer(false);
    ...
    public KciPocketContainer(boolean mutable) {
        super(mutable, KciItemType.DIAMOND_HOE);

        this.containers = new HashSet<>();
    }

    public KciPocketContainer(KciPocketContainer toCopy, boolean mutable) {
    ...
    protected boolean arePocketContainerPropertiesEqual(KciPocketContainer other) {
        return areBaseItemPropertiesEqual(other) && this.containers.equals(other.containers);
    }

    @Override
    public boolean equals(Object other) {
        return other.getClass() == KciPocketContainer.class && arePocketContainerPropertiesEqual((KciPocketContainer) other);
    }

    @Override
    public KciPocketContainer copy(boolean mutable) {
        return new KciPocketContainer(this, mutable);
    }
    ...
    public Set<KciContainer> getContainers() {
