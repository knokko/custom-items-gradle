...
import static nl.knokko.customitems.item.KciItemType.Category.*;
...
public enum KciItemType {
	...
	WOOD_HOE(
			59, true, VERSION1_12, LAST_VERSION,
			HOE, DEFAULT, WAND, GUN, THROWABLE, FOOD, BLOCK, PROJECTILE_COVER
	),
	STONE_HOE(
			131, true, VERSION1_12, LAST_VERSION,
			HOE, DEFAULT, WAND, GUN, THROWABLE, FOOD, BLOCK, PROJECTILE_COVER
	),
	IRON_HOE(
			250, true, VERSION1_12, LAST_VERSION,
			HOE, DEFAULT, WAND, GUN, THROWABLE, FOOD, BLOCK, PROJECTILE_COVER
	),
	DIAMOND_HOE(
			1561, true, VERSION1_12, LAST_VERSION,
			HOE, DEFAULT, WAND, GUN, THROWABLE, FOOD, BLOCK, PROJECTILE_COVER
	),
	GOLD_HOE(
			32, true, VERSION1_12, LAST_VERSION,
			HOE, DEFAULT, WAND, GUN, THROWABLE, FOOD, BLOCK, PROJECTILE_COVER
	),
	...
	NETHERITE_HOE(
			2031, true, VERSION1_16, LAST_VERSION,
			HOE, DEFAULT, WAND, GUN, THROWABLE, FOOD, BLOCK, PROJECTILE_COVER
	),
	...
	OTHER(
			-1, true, VERSION1_14, LAST_VERSION,
			DEFAULT, THROWABLE, FOOD, BLOCK, MUSIC_DISC, ARROW
	);
	...
	KciItemType(int maxDurability, boolean hasSimpleModel, int firstVersion, int lastVersion, Category... categories){
