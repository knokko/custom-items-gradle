...
public class KciShield extends KciTool {

    static KciShield load(
            BitInput input, byte encoding, ItemSet itemSet
    ) throws UnknownEncodingException {
        KciShield result = new KciShield(false);
    ...
    private Collection<AttackEffectGroup> blockingEffects;
    private ItemModel blockingModel;

    public KciShield(boolean mutable) {
        super(mutable, KciItemType.SHIELD);
    ...
    public KciShield(KciShield toCopy, boolean mutable) {
    ...
    protected void loadShieldPropertiesNew(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
        ...
        if (encoding >= 2) {
            ...
            for (int counter = 0; counter < numBlockingEffects; counter++) {
                this.blockingEffects.add(AttackEffectGroup.load(input, itemSet));
            }
        }
    ...
    protected boolean areShieldPropertiesEqual(KciShield other) {
    ...
    public boolean equals(Object other) {
        return other.getClass() == KciShield.class && areShieldPropertiesEqual((KciShield) other);
    }

    @Override
    public KciShield copy(boolean mutable) {
        return new KciShield(this, mutable);
    }
    ...
    public Collection<AttackEffectGroup> getBlockingEffects() {
    ...
    public void setBlockingEffects(Collection<AttackEffectGroup> newBlockingEffects) {
        assertMutable();
    ...
    public void validateIndependent() throws ValidationException, ProgrammingValidationException {
        ...
        for (AttackEffectGroup blockingEffectGroup : blockingEffects) {
