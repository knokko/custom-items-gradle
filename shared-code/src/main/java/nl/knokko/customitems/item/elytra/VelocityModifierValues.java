...
public class VelocityModifierValues extends ModelValues {
    ...
    public static VelocityModifierValues load(BitInput input) throws UnknownEncodingException {
        ...
        VelocityModifierValues result = new VelocityModifierValues(false);
        ...
        for (int counter = 0; counter < numAccelerations; counter++) {
            result.accelerations.add(GlideAccelerationValues.load(input));
        }
    ...
    public VelocityModifierValues(boolean mutable) {
        super(mutable);
    ...
    public VelocityModifierValues(VelocityModifierValues toCopy, boolean mutable) {
        super(mutable);
    ...
    public void save(BitOutput output) {
        ...
        for (GlideAccelerationValues acceleration : accelerations) {
    ...
    public void setAccelerations(Collection<GlideAccelerationValues> newAccelerations) {
        assertMutable();
