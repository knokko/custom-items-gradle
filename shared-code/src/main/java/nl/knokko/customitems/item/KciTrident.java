...
public class KciTrident extends KciTool {

    static KciTrident load(
            BitInput input, byte encoding, ItemSet itemSet
    ) throws UnknownEncodingException {
        KciTrident result = new KciTrident(false);
    ...
    private DamageSourceReference customThrowDamageSource;

    public KciTrident(boolean mutable) {
        super(mutable, KciItemType.TRIDENT);
    ...
    public KciTrident(KciTrident toCopy, boolean mutable) {
    ...
    protected boolean areTridentPropertiesEqual(KciTrident other) {
    ...
    public boolean equals(Object other) {
        return other.getClass() == KciTrident.class && areTridentPropertiesEqual((KciTrident) other);
    }

    @Override
    public KciTrident copy(boolean mutable) {
        return new KciTrident(this, mutable);
    }
    ...
    public DamageSourceReference getCustomThrowDamageSourceReference() {
    ...
    public void setCustomThrowDamageSource(DamageSourceReference newDamageSource) {
        assertMutable();
