...
public class KciBow extends KciTool {
    ...
    public KciBow(boolean mutable) {
        super(mutable, KciItemType.BOW);
    ...
    public KciBow(KciBow toCopy, boolean mutable) {
    ...
    protected boolean areBowPropertiesEqual(KciBow other) {
    ...
    public boolean equals(Object other) {
        return other.getClass() == KciBow.class && areBowPropertiesEqual((KciBow) other);
    }
    ...
    @Override
    public KciBow copy(boolean mutable) {
        return new KciBow(this, mutable);
    }

    @Override
    public BowTexture getTexture() {
        return (BowTexture) super.getTexture();
    }
    ...
    public void setTexture(TextureReference newTexture) {
        if (!(newTexture.get() instanceof BowTexture)) {
    ...
    public void validateIndependent() throws ValidationException, ProgrammingValidationException {
        ...
        if (!(texture.get() instanceof BowTexture)) {
    ...
    public void validateComplete(ItemSet itemSet, String oldName) throws ValidationException, ProgrammingValidationException {
        ...
        if (!(texture.get() instanceof BowTexture)) throw new ProgrammingValidationException("Texture must be a bow texture");
