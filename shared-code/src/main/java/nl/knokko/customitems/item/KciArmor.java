...
public class KciArmor extends KciTool {

    static KciArmor load(
        ...
        KciArmor result = new KciArmor(false, KciItemType.IRON_HELMET);
    ...
    private FancyPantsReference fancyPantsTexture;

    public KciArmor(boolean mutable, KciItemType initialItemType) {
    ...
    public KciArmor(KciArmor toCopy, boolean mutable) {
    ...
    private void load7(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
        load6(input, itemSet);
        this.damageResistances = DamageResistance.load12(input, itemSet);
    }

    private void load8(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
        load6(input, itemSet);
        this.damageResistances = DamageResistance.load14(input, itemSet);
    }
    ...
    protected void load11(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
        loadPre10(input, itemSet);
        this.damageResistances = DamageResistance.load17(input, itemSet);
        loadPost10(input, itemSet);
    }

    protected boolean areArmorPropertiesEqual(KciArmor other) {
    ...
    @Override
    public KciArmor copy(boolean mutable) {
        return new KciArmor(this, mutable);
    }
    ...
    public ArmorTexture getArmorTexture() {
        return armorTexture != null ? armorTexture.get() : null;
    }

    public FancyPantsReference getFancyPantsTextureReference() {
        return fancyPantsTexture;
    }

    public FancyPantsTexture getFancyPantsTexture() {
    ...
    public void setDamageResistances(DamageResistance newDamageResistances) {
        assertMutable();
    ...
    public void setFancyPantsTexture(FancyPantsReference newFpTexture) {
        assertMutable();
