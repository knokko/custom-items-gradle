...
public class EnergyTypeValues extends ModelValues {
    ...
    public static EnergyTypeValues load(BitInput input) throws UnknownEncodingException {
        byte encoding = input.readByte();
        if (encoding != 1) throw new UnknownEncodingException("EnergyType", encoding);

        EnergyTypeValues result = new EnergyTypeValues(false);
    ...
    public EnergyTypeValues(boolean mutable) {
        super(mutable);
    ...
    public EnergyTypeValues(EnergyTypeValues toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public EnergyTypeValues copy(boolean mutable) {
        return new EnergyTypeValues(this, mutable);
    }

    @Override
    public boolean equals(Object other) {
        if (other instanceof EnergyTypeValues) {
            EnergyTypeValues otherEnergy = (EnergyTypeValues) other;
