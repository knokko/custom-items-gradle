...
public class MiningSpeed extends ModelValues {
    ...
    public static MiningSpeed load(BitInput input, ItemSet itemSet) throws UnknownEncodingException {
        byte encoding = input.readByte();
        if (encoding != 1) throw new UnknownEncodingException("MiningSpeed", encoding);

        MiningSpeed result = new MiningSpeed(false);
    ...
    public MiningSpeed(boolean mutable) {
        super(mutable);
    ...
    public MiningSpeed(MiningSpeed toCopy, boolean mutable) {
        super(mutable);
    ...
    @Override
    public MiningSpeed copy(boolean mutable) {
        return new MiningSpeed(this, mutable);
    }

    @Override
    public boolean equals(Object other) {
        if (other instanceof MiningSpeed) {
            MiningSpeed otherSpeed = (MiningSpeed) other;
    ...
    public int getSpeedFor(VMaterial material, KciItem item) {
