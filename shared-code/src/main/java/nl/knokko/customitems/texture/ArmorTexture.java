...
public class ArmorTexture extends ModelValues {
    ...
    public ArmorTexture(boolean mutable) {
        super(mutable);
    ...
    public ArmorTexture(ArmorTexture toCopy, boolean mutable) {
        super(mutable);
    ...
    public boolean equals(Object other) {
        if (other.getClass() == ArmorTexture.class) {
            ArmorTexture otherTexture = (ArmorTexture) other;
    ...
    @Override
    public ArmorTexture copy(boolean mutable) {
        return new ArmorTexture(this, mutable);
    }
    ...
    public void validate(ItemSet itemSet, String oldName) throws ValidationException, ProgrammingValidationException {
        ...
        if (oldName == null || !oldName.equals(name)) {
            for (ArmorTexture otherArmorTexture : itemSet.armorTextures) {
