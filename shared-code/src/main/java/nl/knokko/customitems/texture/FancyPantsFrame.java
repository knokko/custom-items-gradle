...
public class FancyPantsFrame extends ModelValues {

    public static FancyPantsFrame load(BitInput input) throws UnknownEncodingException {
        byte encoding = input.readByte();
        if (encoding != 1) throw new UnknownEncodingException("FancyPantsArmorFrame", encoding);

        FancyPantsFrame frame = new FancyPantsFrame(false);
    ...
    public FancyPantsFrame(boolean mutable) {
        super(mutable);
    ...
    public FancyPantsFrame(FancyPantsFrame toCopy, boolean mutable) {
        super(mutable);
    ...
    public boolean equals(Object other) {
        if (other instanceof FancyPantsFrame) {
            FancyPantsFrame otherFrame = (FancyPantsFrame) other;
    ...
    @Override
    public FancyPantsFrame copy(boolean mutable) {
        return new FancyPantsFrame(this, mutable);
    }
    ...
    public void validate(FancyPantsTexture.Emissivity emissivity) throws ValidationException, ProgrammingValidationException {
        ...
        if (emissivity == FancyPantsTexture.Emissivity.PARTIAL) {
