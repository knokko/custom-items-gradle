...
//    @EventHandler
//    public void craftingTest(PrepareItemCraftEvent event) {
//        String namespace = "unknown";
//        if (event.getRecipe() instanceof Keyed) namespace = ((Keyed) event.getRecipe()).getKey().getNamespace();
//
//        Bukkit.broadcastMessage("PrepareItemCraftEvent " + namespace);
//        if (event.getRecipe() instanceof ShapedRecipe) {
//            if (namespace.equals("customitems")) {
//                ItemStack[] matrix = event.getInventory().getMatrix();
//                ItemStack axe = matrix[0];
//                if (axe == null || axe.getEnchantmentLevel(DIG_SPEED) != 1) {
//                    event.getInventory().setResult(null);
//                    Bukkit.broadcastMessage("Block");
//                } else event.getInventory().setResult(new ItemStack(Material.IRON_SHOVEL, 2));
//            }
//        }
//
//        if (namespace.equals("minecraft")) {
//            Bukkit.broadcastMessage("block vanilla early");
//            event.getInventory().setResult(null);
//        }
//    }
//
//    @EventHandler
//    public void craftingTest(CraftItemEvent event) {
//        String namespace = "unknown";
//        if (event.getRecipe() instanceof Keyed) namespace = ((Keyed) event.getRecipe()).getKey().getNamespace();
//
//        Bukkit.broadcastMessage("CraftItemEvent " + namespace);
//        if (event.getRecipe() instanceof ShapedRecipe) {
//            if (namespace.equals("customitems")) {
//                ItemStack[] matrix = event.getInventory().getMatrix();
//                ItemStack axe = matrix[0];
//                Bukkit.broadcastMessage("matrix is " + Arrays.toString(matrix));
//                if (axe == null || axe.getEnchantmentLevel(DIG_SPEED) != 1) {
//                    event.setCancelled(true);
//                    Bukkit.broadcastMessage("Cancel");
//                } else {
//                    event.getInventory().setResult(new ItemStack(Material.IRON_SHOVEL, 2));
//                }
//            }
//        }
//
//        if (namespace.equals("minecraft")) {
//            Bukkit.broadcastMessage("Block vanilla late");
//            event.setCancelled(true);
//        }
//    }
}
