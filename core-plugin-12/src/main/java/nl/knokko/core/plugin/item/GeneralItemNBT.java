...
public class GeneralItemNBT {
	...
	public static GeneralItemNBT readOnlyInstance(ItemStack bukkitStack) {
		return new GeneralItemNBT(CraftItemStack.asNMSCopy(bukkitStack), false);
	}
	
	public static GeneralItemNBT readWriteInstance(ItemStack bukkitStack) {
