...
public class GeneralItemNBT14 implements GeneralItemNBT {

    private final net.minecraft.server.v1_14_R1.ItemStack nmsStack;
    private NBTTagCompound tag;
    private final boolean canWrite;

    GeneralItemNBT14(net.minecraft.server.v1_14_R1.ItemStack nmsStack, boolean canWrite) {
