...
class GeneralItemNBT13 implements GeneralItemNBT {

    private final net.minecraft.server.v1_13_R2.ItemStack nmsStack;
    private NBTTagCompound tag;
    private final boolean canWrite;

    GeneralItemNBT13(net.minecraft.server.v1_13_R2.ItemStack nmsStack, boolean canWrite) {
